# The links further below are broken. Instead, download model files manually from:
# https://drive.google.com/uc?id=1QCSxJZpnWvM00hx49CJ2zky7PWGzpcEh
echo "The URLs to pre-trained model files have been down for a long time."
echo "Consider downloading them manually, following the maintainer's comment here:
